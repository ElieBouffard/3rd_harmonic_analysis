...
hdulist.append(fits.open('../../../Data_sets/HAT-P-7/kplr010666592-2009131105131_llc.fits'))
hdulist.append(fits.open('../../../Data_sets/HAT-P-7/kplr010666592-2009166043257_llc.fits'))
hdulist.append(fits.open('../../../Data_sets/HAT-P-7/kplr010666592-2009259160929_llc.fits'))
hdulist.append(fits.open('../../../Data_sets/HAT-P-7/kplr010666592-2009350155506_llc.fits'))
hdulist.append(fits.open('../../../Data_sets/HAT-P-7/kplr010666592-2010078095331_llc.fits'))
hdulist.append(fits.open('../../../Data_sets/HAT-P-7/kplr010666592-2010174085026_llc.fits'))
hdulist.append(fits.open('../../../Data_sets/HAT-P-7/kplr010666592-2010265121752_llc.fits'))
hdulist.append(fits.open('../../../Data_sets/HAT-P-7/kplr010666592-2010355172524_llc.fits'))
hdulist.append(fits.open('../../../Data_sets/HAT-P-7/kplr010666592-2011073133259_llc.fits'))
hdulist.append(fits.open('../../../Data_sets/HAT-P-7/kplr010666592-2011177032512_llc.fits'))
hdulist.append(fits.open('../../../Data_sets/HAT-P-7/kplr010666592-2011271113734_llc.fits'))
hdulist.append(fits.open('../../../Data_sets/HAT-P-7/kplr010666592-2012004120508_llc.fits'))
hdulist.append(fits.open('../../../Data_sets/HAT-P-7/kplr010666592-2012088054726_llc.fits'))
hdulist.append(fits.open('../../../Data_sets/HAT-P-7/kplr010666592-2012179063303_llc.fits'))
hdulist.append(fits.open('../../../Data_sets/HAT-P-7/kplr010666592-2012277125453_llc.fits'))
hdulist.append(fits.open('../../../Data_sets/HAT-P-7/kplr010666592-2013011073258_llc.fits'))
hdulist.append(fits.open('../../../Data_sets/HAT-P-7/kplr010666592-2013098041711_llc.fits'))
hdulist.append(fits.open('../../../Data_sets/HAT-P-7/kplr010666592-2013131215648_llc.fits'))

planet_period = 2.204735365
first_transit = 121.3585723
transit_duration = 3.88216/24.
...
print 'There are ', len(hdulist), 'files. Therefore, you must concatenate elements from 0 to ', len(hdulist) - 1, '!!!'
...
time = np.ma.concatenate([time[0],time[1],time[2],time[3],time[4],time[5],time[6],time[7],time[8],time[9],time[10],time[11],time[12],time[13],time[14],time[15],time[16],time[17]])
PDCSAP_FLUX = np.ma.concatenate([PDCSAP_FLUX[0],PDCSAP_FLUX[1],PDCSAP_FLUX[2],PDCSAP_FLUX[3],PDCSAP_FLUX[4],PDCSAP_FLUX[5],PDCSAP_FLUX[6],PDCSAP_FLUX[7],PDCSAP_FLUX[8],PDCSAP_FLUX[9],PDCSAP_FLUX[10],PDCSAP_FLUX[11],PDCSAP_FLUX[12],PDCSAP_FLUX[13],PDCSAP_FLUX[14],PDCSAP_FLUX[15],PDCSAP_FLUX[16],PDCSAP_FLUX[17]])
SAP_FLUX = np.ma.concatenate([SAP_FLUX[0],SAP_FLUX[1],SAP_FLUX[2],SAP_FLUX[3],SAP_FLUX[4],SAP_FLUX[5],SAP_FLUX[6],SAP_FLUX[7],SAP_FLUX[8],SAP_FLUX[9],SAP_FLUX[10],SAP_FLUX[11],SAP_FLUX[12],SAP_FLUX[13],SAP_FLUX[14],SAP_FLUX[15],SAP_FLUX[16],SAP_FLUX[17]])
PDCSAP_FLUX_err = np.ma.concatenate([PDCSAP_FLUX_err[0],PDCSAP_FLUX_err[1],PDCSAP_FLUX_err[2],PDCSAP_FLUX_err[3],PDCSAP_FLUX_err[4],PDCSAP_FLUX_err[5],PDCSAP_FLUX_err[6],PDCSAP_FLUX_err[7],PDCSAP_FLUX_err[8],PDCSAP_FLUX_err[9],PDCSAP_FLUX_err[10],PDCSAP_FLUX_err[11],PDCSAP_FLUX_err[12],PDCSAP_FLUX_err[13],PDCSAP_FLUX_err[14],PDCSAP_FLUX_err[15],PDCSAP_FLUX_err[16],PDCSAP_FLUX_err[17]])
