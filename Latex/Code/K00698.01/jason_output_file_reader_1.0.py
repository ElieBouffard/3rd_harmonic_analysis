...
parameters = np.loadtxt("../../Jason_code_outputs/K00698.01/newfit.dat", usecols = ([1]))
transit_center = parameters[8]
period = parameters[9]
orbital_frequency = 1./period
time, flux, flux_err = np.loadtxt("../../Jason_code_outputs/K00698.01/K00698.01_res.dat", usecols = (0,1,2), unpack = True)
