...
parameters = np.loadtxt("../../Jason_code_outputs/K00823.01/newfit.dat", usecols = ([1]))
transit_center = parameters[8]
period = parameters[9]
orbital_frequency = 1./period
time, flux, flux_err = np.loadtxt("../../Jason_code_outputs/K00823.01/K00823.01.res.dat", usecols = (0,1,2), unpack = True)
