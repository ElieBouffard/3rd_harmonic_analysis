...
#This code computes the Lomb-Scargle periodogram of K00256.01 using
#AstroPy.
...
planet_period = 1.378651791#1.37868#
...
SAP_FLUX_err = np.ma.concatenate([SAP_FLUX_err[0],SAP_FLUX_err[1],SAP_FLUX_err[2],SAP_FLUX_err[3],SAP_FLUX_err[4],SAP_FLUX_err[5],SAP_FLUX_err[6],SAP_FLUX_err[7],SAP_FLUX_err[8],SAP_FLUX_err[9],SAP_FLUX_err[10],SAP_FLUX_err[11],SAP_FLUX_err[12],SAP_FLUX_err[13]])
